...
pxWidget.jQuery.extend(pxWidget.jQuery.fn.dataTableExt.oSort, {
  "data-asc": function (a, b) {
    a = a.toString().replace(app.config.entity.data.datatable.null, -9999999999).replace(new RegExp(pxWidget.thousandSeparator(), 'g'), "");
    b = b.toString().replace(app.config.entity.data.datatable.null, -9999999999).replace(new RegExp(pxWidget.thousandSeparator(), 'g'), "");
