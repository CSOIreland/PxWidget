!(function (t, e) {
    ...
    (L.Control.EasyPrint = L.Control.extend({
        ...
        onAdd: function () {
            ...
            var t = pxWidget.L.DomUtil.create("div", "leaflet-control-easyPrint leaflet-bar leaflet-control");
            if (!this.options.hidden) {
                //remove listener events as we don't show droppdown and trigger event on main button now
                this._addCss();//pxWidget.L.DomEvent.addListener(t, "mouseover", this._togglePageSizeButtons, this), pxWidget.L.DomEvent.addListener(t, "mouseout", this._togglePageSizeButtons, this);

                var e = "leaflet-control-easyPrint-button";
                this.options.exportOnly && (e += "-export"),
                    (this.link = pxWidget.L.DomUtil.create("a", e, t)),
                    (this.link.id = "leafletEasyPrint"),
                    (this.link.title = this.options.title);
                //change event listener to main button instead of dropdowns
                pxWidget.L.DomEvent.addListener(this.link, "click", function () {
                    this.printMap('CurrentSize', this.options.filename)
                }, this);
                (this.holder = pxWidget.L.DomUtil.create("ul", "easyPrintHolder", t)),
                    this.options.sizeModes.forEach(function (t) {
                        var e = pxWidget.L.DomUtil.create("li", "easyPrintSizeMode", this.holder);
                        e.title = t.name;
                        pxWidget.L.DomUtil.create("a", t.className, e);
                        //remove event listener on elements that no longer appear
                        // pxWidget.L.DomEvent.addListener(e, "click", this.printMap, this);
                    }, this),
                    pxWidget.L.DomEvent.disableClickPropagation(t);
            }
            return t;
        },
        ...
        _printOpertion: function (t) {
            var e = this,
                ...
                o = this.mapContainer.clientWidth;
            ((this.originalState.widthWasAuto && "CurrentSize" === t) || (this.originalState.widthWasPercentage && "CurrentSize" === t)) && (o = this.originalState.mapWidth),
                n
                    ...
                    .toPng(e.mapContainer, { width: o, height: e.mapContainer.clientHeight })
                    .then(function (t) {
        ...
        (L.easyPrint = function (t) {
            return new pxWidget.L.Control.EasyPrint(t);
        });
});
